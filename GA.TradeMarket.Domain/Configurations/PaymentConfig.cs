    ...
    public class PaymentConfig : IEntityTypeConfiguration<Payment>
    {
        public void Configure(EntityTypeBuilder<Payment> builder)
        {
            ...
            builder.HasData(
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 2, paymentMethodId = 2, Id = 2 , PaymentMethod = "Mobile Bank" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 4, paymentMethodId = 4, Id = 4, PaymentMethod = "Credit card" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 1, paymentMethodId = 6, Id = 6, PaymentMethod = "Visa Card" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 2, paymentMethodId = 8, Id = 8, PaymentMethod = "Mobile Bank" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 4, paymentMethodId = 3, Id = 10, PaymentMethod = "Visa Card" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 2, paymentMethodId = 4, Id = 12, PaymentMethod = "Master Card" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 6, paymentMethodId = 7, Id = 15, PaymentMethod = "Wallet" },
                  ...
                  new Payment() { PaymentDate = DateTime.Now.AddDays(-rnd.Next(3, 30)), Amount = rnd.Next(30, 1000), OrderId = 4, paymentMethodId = 5, Id = 17, PaymentMethod = "Apple pay" },
