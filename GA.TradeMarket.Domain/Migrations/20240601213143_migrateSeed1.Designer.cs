...
namespace GA.TradeMarket.Domain.Migrations
{
    ...
    [Migration("20240601213143_migrateSeed1")]
    partial class migrateSeed1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GA.TradeMarket.Domain.Entitites.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Buy = 1.0m,
                            Currency = "USD",
                            LogTime = new DateTime(2024, 6, 2, 1, 31, 42, 465, DateTimeKind.Local).AddTicks(9998),
                            Sell = 1.0m
                        },
                        new
                        {
                            ...
                            Buy = 0.85m,
                            Currency = "EUR",
                            LogTime = new DateTime(2024, 6, 2, 1, 31, 42, 466, DateTimeKind.Local).AddTicks(10),
                            Sell = 0.85m
                        });
                });
